...
point_cloud_fname = 'mapping/{:s}_map_pts_and_keyframes.txt'.format(seq_name)
keyframe_trajectory_fname = 'KeyFrameTrajectory.txt'
visit_counter_fname = 'mapping/{:s}_filtered_{:d}_scale_{:d}_visit_counter.txt'.format(
    seq_name, filter_ground_points, scale_factor)
occupied_counter_fname = 'mapping/{:s}_filtered_{:d}_scale_{:d}_occupied_counter.txt'.format(
    seq_name, filter_ground_points, scale_factor)
...
cv2.imwrite('bit_buddy.pgm', grid_map_resized)
