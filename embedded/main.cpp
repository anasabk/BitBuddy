...
extern "C" int main() {
	...
	legs[2].move(30, 55, 170, 0, 0, 0);
	legs[3].move(30, 55, 170, 0, 0, 0);
	sleep(4);
	usleep(20000);
	...
	for(int i = 0; i < 20; i++) {
		...
		usleep(200000);
		legs[0].move_offset(-20, 0, 0, 0, 0, 0);
		legs[1].move_offset(-25, 0, 0, 0, 0, 0);
		legs[2].move_offset(-25, 0, 0, 0, 0, 0);
		legs[3].move_offset(-20, 0, 0, 0, 0, 0);

		usleep(20000);
		legs[0].move(-50, 55, 100, 0, 0, 0);
		usleep(20000);
		legs[0].move(-25, 55, 100, 0, 0, 0);
		usleep(100000);
