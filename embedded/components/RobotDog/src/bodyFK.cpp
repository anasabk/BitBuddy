...
void Body::sit_down() {
    ...
    leg_buf[RIGHTFRONT][0] =  30, leg_buf[RIGHTFRONT][1] = 55, leg_buf[RIGHTFRONT][2] = 65;
    leg_buf[LEFTBACK][0]   = -50, leg_buf[LEFTBACK][1]   = 55, leg_buf[LEFTBACK][2]   = 65;
...
void Body::stand_up() {
    ...
    leg_buf[RIGHTFRONT][0] =  30, leg_buf[RIGHTFRONT][1] = 55, leg_buf[RIGHTFRONT][0] = 0;
    leg_buf[LEFTBACK][0]   = -50, leg_buf[LEFTBACK][1]   = 55, leg_buf[LEFTBACK][0]   = 0;
