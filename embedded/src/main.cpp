...
extern "C" int main() {
	...
	Leg legs[4] {
		Leg(&servo[0],   0, &servo[1], 12.443508, &servo[2], -3.844949, 55, 110, 130, false),
		Leg(&servo[3],   0, &servo[4], -3.443508, &servo[5], 6.844949, 55, 110, 130, true),
	...
	for(int i = 0; i < 10; i++) {
		usleep(20000);
		legs[2].move(35, 20, 130);
		usleep(20000);
		legs[2].move(60, 20, 130);
		usleep(100000);
		legs[2].move(60, 20, 170);
		usleep(200000);
		...
		usleep(20000);
		legs[0].move(-50, 20, 130);
		usleep(20000);
		legs[0].move(-25, 20, 130);
		usleep(100000);
		legs[0].move(-25, 20, 170);
		usleep(200000);
		legs[0].move_offset(-25, 0, 0);
		legs[1].move_offset(-25, 0, 0);
		...
		usleep(20000);
		legs[3].move(35, 20, 130);
		usleep(20000);
		legs[3].move(60, 20, 130);
		usleep(100000);
		legs[3].move(60, 20, 170);
		usleep(200000);
		legs[0].move_offset(-25, 0, 0);
		legs[1].move_offset(-25, 0, 0);
		legs[2].move_offset(-25, 0, 0);
		...
		usleep(20000);
		legs[1].move(-50, 20, 130);
		usleep(20000);
		legs[1].move(-25, 20, 130);
		usleep(100000);
		legs[1].move(-25, 20, 170);
		usleep(200000);
		legs[0].move_offset(-25, 0, 0);
		legs[1].move_offset(-25, 0, 0);
		legs[2].move_offset(-25, 0, 0);
