...
extern "C" int main() {
	...
	for(int i = 0; i < 10; i++) {
		usleep(20000);
		legs[0].move_offset(0, -5, 0);
		legs[1].move_offset(0,  5, 0);
		legs[2].move_offset(0,  5, 0);
		legs[3].move_offset(0, -5, 0);
		usleep(20000);
		...
		usleep(200000);
		legs[0].move_offset(-25,  5, 0);
		legs[1].move_offset(-25, -5, 0);
		legs[2].move_offset(-25, -5, 0);
		legs[3].move_offset(-25,  5, 0);
